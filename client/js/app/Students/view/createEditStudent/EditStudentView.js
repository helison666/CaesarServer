...
(function (This, app) {
    This.EditStudentView = Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            if (this.attachment) {
                this.subAttachment.initExistant(this.attachment.toJSON());
            }
        },
        ...
        render: function () {
            ...
            model = _.extend(model, this.subAttachment.toJSON());
        ...
        editStudent: function () { 
            ...
            if (isPassedValid) {
                ...
                this.subAttachment.deleteTrigger();

                if (this.attachment) {
                    this.attachment.set({
                        key: studentSurname + ' ' + studentName,
                        cv: this.subAttachment.get('cv'),
                        photo: this.subAttachment.get('photo')
                    });
        ...
        removePhoto: function (e) {
            ...
            this.subAttachment.delayDeletePhoto(delName);
        },
        ...
        removeCV: function (e) {
            ...
            this.subAttachment.delayDeleteCV(delName);
        }
    });
})(CS.Students, app);