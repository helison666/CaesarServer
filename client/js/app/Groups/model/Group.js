...
(function (This, i) {
    ...
    This.Group = Backbone.Model.extend({
        ...
        checkGroupKey: function (groupName) {
        ...
        unCheckGroup: function () {
            this.set('checked', false, {silent: true});
        },

        checkGroup: function () {
            this.set('checked', true, {silent: true});
        },

        checkForEdit: function () {
            this.set('checkedForEdit', true);
        },

        unCheckForEdit: function () {
            this.set('checkedForEdit', false);
        },

        isCheckedForEdit: function () {
            return this.get('checkedForEdit');
        },

        triggerCheckGroup: function () {
            this.set('checked', !(this.get('checked')), {silent: true});
        },
            ...
            return {
                ...
                teachers: function (teachers) {
                    ...
                    isTeachersValid = teachers.every(function (teacher) {
                        return (i.teachers.indexOf(teacher) !== -1 || i.teachers.indexOf(teacher.slice(teacher.indexOf(' ') + 1)));
                    });
